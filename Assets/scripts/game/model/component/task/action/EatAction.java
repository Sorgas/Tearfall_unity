...
//            maxProgress = 400;
    ...
    private Building getChairNearTable(BuildingBlock tableBlock) {
        return Stream.of(
                checkChairAtPosition(IntVector3.add(tableBlock.position, 1, 0, 0), OrientationEnum.W),
                checkChairAtPosition(IntVector3.add(tableBlock.position, -1, 0, 0), OrientationEnum.E),
                checkChairAtPosition(IntVector3.add(tableBlock.position, 0, 1, 0), OrientationEnum.S),
                checkChairAtPosition(IntVector3.add(tableBlock.position, 0, -1, 0), OrientationEnum.N))
                .filter(Objects::nonNull)
                .findFirst().orElse(null);
    }

    private Building checkChairAtPosition(IntVector3 position, OrientationEnum orientation) {
