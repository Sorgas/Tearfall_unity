...
namespace util.geometry.bounds {
    public class IntBounds3 : IntBounds2 {
        ...
        public List<Vector3Int> getExternalBorders(BoundsBorderLookupType type) {
            var result = new List<Vector3Int>();
            if (type != BoundsBorderLookupType.SAME_LEVEL_ONLY) {
    ...
    public enum BoundsBorderLookupType {
        SAME_LEVEL_ONLY, // only z levels of bounds
        ALL
    }
}